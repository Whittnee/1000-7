  ...
  return (
    <div className={styles.productTabs}>
      <ul className={styles.tabs}>
        ...
        <li className={clsx(styles.tab, {[styles.active]: toggle === 2})} onClick={() => updateToggle(2)}><span>Raiting & Reviews</span></li>
        {/* <li className={clsx(styles.tab, {[styles.active]: toggle === 3})} onClick={() => updateToggle(3)}><span>FAQs</span></li> */}
      </ul> 
      <div className={clsx(styles.tabContent, {[styles.active]: toggle === 1})}></div>
      <div className={clsx(styles.tabContent, {[styles.active]: toggle === 2})}>
        <div className={styles.container}>
          <h3 className={styles.title}>All Reviews <span className={styles.count}>({reviews.length})</span></h3>
      ...
      <div className={clsx(styles.tabContent, {[styles.active]: toggle === 3})}></div>
    </div>
  )
}